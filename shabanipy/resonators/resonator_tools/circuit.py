...
from shabanipy.resonators.resonator_tools.utilities import plotting, save_load, Watt2dBm, dBm2Watt
from shabanipy.resonators.resonator_tools.circlefit import circlefit
from shabanipy.resonators.resonator_tools.calibration import calibration
...
class reflection_port(circlefit, save_load, plotting, calibration):
    ...
    def GUIfit(self):
        ...
        from matplotlib import Slider, Button
