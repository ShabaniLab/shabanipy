...
# load data 
z_field, gate, rxx, ryx = Loader.load_density()

density, mobility_xx, _ = get_density_mobility(z_field.T, ryx.T, rxx.T, rxx.T, Loader.GEOMETRIC_FACTOR, z_field_range=[0, 1])
...
ax.legend(loc=4)
ax2 = ax.twinx()
ax2.scatter(gate[0, :], mobility_xx*1e4,
    color=colors[-1],
    linestyle='None', 
    marker='o',
    s=8,
