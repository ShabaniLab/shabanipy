...
z_field_yy, ryy = Loader.get_data(tag='NW-VYY')
z_field_xy, rxy = Loader.get_data(tag='NW-VXY')
...
ax.set_title(name + " Device NW (June 2023), $I=20$ nA, $p =$" + f"{density[0]/1e4:.2e}" + r" cm$^{-2}$")
fig.set_size_inches(5, 5)
path = f"{name.lower()}-nw-all-traces.pdf"
