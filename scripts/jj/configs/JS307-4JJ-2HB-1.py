...
BASE_FOLDER = r'/Users/mdartiailh/Labber/Data/2020/02'
...
#: - Tc (in K)
#: - gap size (in nm)
SAMPLES = {"JJ300": {"path": "Data_0203/JS307-4JJ+2HB-KS002-JJ300nm-005.hdf5",
                     "Tc": 1.46, "gap size": 300},
            }

#: Path to the file in which to write the output
OUTPUT = "/Users/mdartiailh/Documents/PostDocNYU/DataAnalysis/JJ/JS307-4JJ-2HB-1/results.csv"
