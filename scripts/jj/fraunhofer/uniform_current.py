...
g = fraunhofer(jx, x, bfields=b, jj_length=jj_length, ret_fourier=True)
...
ax2.plot(b / 1e-3, theta_r / np.pi, lw=1, marker=".", markersize=2, label="romb")
ax2.plot(b / 1e-3, theta_q / np.pi, lw=1, marker=".", markersize=2, label="quad")
ax2.plot(b / 1e-3, theta_h / np.pi, lw=1, marker=".", markersize=2, label="hilbert")
ax2.plot(
    b / 1e-3, theta_true_unwrapped / np.pi, lw=1, marker=".", markersize=2, label="true"
)
ax2.legend()
